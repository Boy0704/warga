<div class="card">
     <div class="card-body">
          <div class="row mb-4">
               <div class="col">
                    <a href="rt/create" class="btn btn-primary"><i class="bx bx-plus mr-1"></i>Tambah</a>
                    ...
                    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModal"
                         ...
                         <div class="modal-dialog">
                              <form action="rt/import_excel" method="post" enctype="multipart/form-data">
                                   <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                             <div class="row mb-3">
                                                  <div class="col-sm-9">
                                                       <a href="files/excel/import_rt.xlsx"
                        ...
                        foreach ($rt_data as $rt)
                        {
                         ...
                         <tr>
                              ...
                              <td style="text-align:center" width="200px">
                                   ...
                                   <a href="rt/update/<?php echo $rt->id_rt ?>" title="Update Data"
                                        class="btn btn-sm btn-primary"><i class="bx bx-edit me-0"></i>
                                   </a>
                                   <a href="rt/delete/<?php echo $rt->id_rt ?>" title="Hapus Data"
